...
namespace Time2
{
    public class Time2
    {
        ...
        //12 : 45 : 505
        public virtual void AddTime(int h, int m, int s)
        {
        ...
        public virtual void AddTime(int minutes)
        {
            int combinedMinutes = minutes + this.Minute;
            if (combinedMinutes > 59)
            {
                this.Hour++;
                this.Minute = combinedMinutes - 60;
            }
            else
                this.Minute = combinedMinutes;
        }
        public virtual void AddTime(Time2 time) => AddTime(time.Hour, time.Minute, time.Second);
